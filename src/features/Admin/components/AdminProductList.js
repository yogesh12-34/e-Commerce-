...
import { fetchAllProductsAsync, fetchBrandsAsync, fetchCategoriesAsync, fetchProductsByFiltersAsync,selectAllProducts, selectBrands, selectCategories, selectTotalItems } from "../../product/productSlice";
        ...
        <div className="bg-white">
          ...
          filters={filters}></MobileFilter>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* section of producsts and filters ends here */}
...
function MobileFilter({mobileFiltersOpen,
...
function Pagination({page,setPage,handlePage,totalItems}){
  ...
  return(<div>  <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6"></div>
  ...
  <div>
    ...
    >
     ...
     <div
        ...
        aria-current="page"
        className={`relative z-10  cursor-pointer inline-flex items-center ${index+1===page? `bg-indigo-600 text-white`:`text-gray-400 `} px-4 py-2 text-sm 
